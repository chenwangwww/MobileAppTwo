------------------------------------------------------------------------
local TGGSettingLayer = class("TGGSettingLayer", function()
    return cc.LayerColor:create(cc.c4b(0, 0, 0, 180), display.width, display.height)
end)

function TGGSettingLayer:ctor(scene)
    self.scene = scene
    ...
    self.layer = cc.CSLoader:createNode("game/tgg/res/TGGSettingLayer.csb")
...
function TGGSettingLayer:addWinClick()
...
function TGGSettingLayer:doClose()
    PlazaManager.playClickEffect()
    self:removeFromParent()
end

function TGGSettingLayer:onEnterTransitionFinish()
end

function TGGSettingLayer:onExit()

end

return TGGSettingLayer

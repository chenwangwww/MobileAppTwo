local JSFYAPP = class("JSFYAPP", cc.load("mvc").AppBase)

function JSFYAPP:ctor()
    PlazaManager.CENTER_APP = "game.jsfy.src.JSFYScene"
    self.configs_ = {
        viewsRoot = "game.jsfy.src",
        modelsRoot = "app.models",
        defaultSceneName = "JSFYScene"
    }

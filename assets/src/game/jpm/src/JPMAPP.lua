local JPMAPP = class("JPMAPP", cc.load("mvc").AppBase)

function JPMAPP:ctor()
    PlazaManager.CENTER_APP = "game.jpm.src.JPMScene"
    self.configs_ = {
        viewsRoot = "game.jpm.src",
        modelsRoot = "app.models",
        defaultSceneName = "JPMScene"
    }

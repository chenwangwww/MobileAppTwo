...
local TBNNStatus = class("TBNNStatus")
...
function TBNNStatus:setState(gameState, ...)
    self:show(true)
...
function TBNNStatus:getState()
    return self.state_
end

function TBNNStatus:show(visible)

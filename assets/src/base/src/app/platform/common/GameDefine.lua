...
GameDefine.platformUpdateUrl = {
    ["android"] = "http://b.xingyuegame777.com/r8yl/gameres/assets/android/app/gamelist1.json",
    ["ios"] = "http://b.xingyuegame777.com/r8yl/gameres/assets/ios/app/gamelist2.json"
}

...
GameDefine.loginIp = {"47.239.96.22", "47.239.96.22", "47.239.96.22"}
...
GameDefine.loginIp_test = {"154.39.249.136"}
GameDefine.loginPort_test = {7500}

-- 审核版本ip
GameDefine.loginIp_check = {"101.132.158.128", "login01.daqi78.net"}
GameDefine.loginPort_check = {8300, 8301, 8302, 61300, 61301, 61302}

-- 配置文件更新地址 每个平台配置文件单独 方便后期控制
GameDefine.platformUpdateUrl = {
    ["android"] = "http://47.239.96.22:8108/r8yl/gameres/assets/android/app/gamelist1.json",
    ["ios"] = "https://47.239.96.22:9108/r8yl/gameres/assets/ios/app/gamelist2.json"
}
